...
const plugins: WebpackPluginInstance[] = [
  new DefinePlugin({
    ...
    'process.env.INTERVIEW_REQUEST_API_URL': JSON.stringify(process.env.INTERVIEW_REQUEST_API_URL),
    ...
    'process.env.MICROSERVICE_API_KEY': JSON.stringify(process.env.MICROSERVICE_API_KEY),
    //App Features
