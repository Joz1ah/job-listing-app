...
interface HunterInterviewCalendarModalProps {
  isOpen: boolean;
  onClose: () => void;
  existingMeetings?: Meeting[];
}

const HunterInterviewCalendarModal: React.FC<
  HunterInterviewCalendarModalProps
> = ({
  isOpen,
  onClose,
  existingMeetings = [
...
export { HunterInterviewCalendarModal };
