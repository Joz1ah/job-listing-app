...
// Modified to accept closeOnOutsideClick prop
const Dialog = ({ closeOnOutsideClick = true, ...props }) => (
...
>(({ className, children, closeOnOutsideClick = true, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      // This is the key change - only allow outside clicks to close if closeOnOutsideClick is true
    ...
    >
      {children}
      {/* Only show the close button if we want to allow closing */}
