...
const inputWrapperVariants = cva("relative pt-4 w-full", {
  variants: {
    variant: {
      default: "",
      primary: "",
...
const labelWrapperVariants = cva("absolute -top-3 left-4 px-2 z-20", {
  variants: {
    variant: {
...
const alertIconVariants = cva("fill-[#E63946]", {
  variants: {
    variant: {
...
const tooltipIconVariants = cva("relative -top-1 cursor-pointer", {
  variants: {
    variant: {
