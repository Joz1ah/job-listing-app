    ...
    <header className="fixed top-0 left-0 right-0 bg-[#2D3A41] h-[72px] pr-4 flex flex-row justify-between items-center flex-nowrap z-50">
      <div className="flex flex-row items-center space-x-8 flex-shrink-0">
        ...
        <nav className="flex flex-col md:flex-row items-center space-y-4 md:space-y-0">
          <ul className="space-y-4 md:space-y-0 space-x-[50px] text-white text-[16px] font-light flex flex-col md:flex-row items-center">
        ...
        <NavLink to="/job-feed-employer/job-creation">
          <Button className="bg-orange-500 w-[172px] h-[44px] font-light mt-4 md:mt-0">
            Create Job listing
          </Button>
        </NavLink>
      </div>
