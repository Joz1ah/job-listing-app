...
interface ExpiredSubModalEmployerProps {
  open: boolean;
...
const ExpiredSubModalEmployer: React.FC<ExpiredSubModalEmployerProps> = ({
  open,
  onOpenChange,
}) => {
  ...
  const features: PlanFeatures = {
    yearly: [
      ...
      { icon: <MessageCircleMore />, text: "Exclusive Employer Resources" },
...
export { ExpiredSubModalEmployer };
