  ...
  const renderHeader = () => (
    <div className="mb-2">
      ...
      <p className="text-[#F8F8FF] text-[13px]">
        Select the perfect plan for your needs: get started with our $5 monthly
        plan for easy access to all essential features, or save more with our
        $55 yearly plan, offering full access to premium content and exclusive
