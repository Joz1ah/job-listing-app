...
export { TermsAndConditions } from 'pages/terms-and-conditions/TermsAndConditions'
export { PrivacyPolicy } from 'pages/privacy-policy/PrivacyPolicy'
export { InterruptedSubscriptionPage } from 'pages/subscription-plan/interrupted-plan/InterruptedSubscriptionPage'
export { ComingSoon } from 'pages/coming-soon/coming-soon'
