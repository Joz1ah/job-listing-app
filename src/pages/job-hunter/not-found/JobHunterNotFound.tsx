...
const JobHunterNotFound: FC = () => {
  return (
    <>
      <PageMeta title="Not Found" />
      <div className="flex flex-col items-center justify-center w-full mx-auto md:mt-16 text-center px-4 text-white">
