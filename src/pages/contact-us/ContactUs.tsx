...
import envelopecheck from "assets/contact-us/envelope-circle-check.svg?url";
          ...
          <div className={style["form-container-wrapper"]}>
            <div className={style["form-container"]}>
              {!messageSuccess ? (
                <>
                  ...
                  <Formik
                    ...
                    validationSchema={Yup.object({
                      ...
                      userType: Yup.string()
                        .oneOf(
                          ["Job Hunter", "Employer", "Prefer not to say"],
                  ...
                  >
                    {({ errors, touched, handleSubmit, isValid, dirty }) => {
                      // Consider form valid only when all validations pass AND all required fields are dirty (touched)
                      const formValid =
                        isValid &&
                        dirty &&
                        !!touched.firstName &&
                        ...
                        <form onSubmit={handleSubmit}>
                          <div className={style["form-body"]}>
                            ...
                            <div className={style["radio-group-container"]}>
                              <div className={style["radio-group-title"]}>
                                ...
                                <Field name="message">
                                  {({ field, form }: FieldProps) => (
                                    <Textarea
                                      ...
                                      className={`bg-transparent border-[#000] h-[100px] border-2 focus:border-[#F5722E] placeholder:text-[#AEADAD] ${touched.message && errors.message ? "border-[#E63946] pr-10" : ""}`}
                                      onChange={(
                            ...
                            <div className={style["maximum-words"]}>
                              Maximum of 500 words
                            </div>
                            <div
                              className={style["form-button-submit-wrapper"]}
                            >
                              <button
                                type="submit"
                                className={`${!formValid ? style["button-invalid"] : ""}`}
                              >
                                {isLoading ? (
                                  <Spinner />
                                ) : (
                ...
                <div
                  className={`${style["form-success"]} ${isAnimated ? style["visible"] : ""}`}
                >
            ...
            <div
              className={`${style["contact-us-details-body"]} flex flex-col gap-4 sm:flex-row md:flex-col lg:flex-row w-full`}
            >
              <div
                className={`${style["column-a"]} flex-1 flex flex-col gap-4`}
              >
                <div
                  className={`${style["contact-us-details-item"]} flex w-full`}
                >
                  <div className="">
                    <img src={envelopecheck} />
                  </div>
                  <div className="flex-1">support@akaza.io</div>
                </div>
              </div>
              <div className={`${style["column-b"]} flex-1`}>
                <div
                  className={`${style["contact-us-details-item"]} flex w-full`}
                >
                  <div className="">
                  ...
                  <div className="flex-1">
                    PO Box 12302 Woodbridge RPO Rutherford, ON, L4H 2T3
                  </div>
                </div>
              </div>
            </div>
