    ...
    <DefaultLayout>
      <div className="bg-[#263238] flex lg:justify-center lg:items-center w-full pt-5 select-none">
          <div className="flex w-[67rem] xl:w-[1100px] xl:pl-[2.5rem] xl:bg-[#2D3A41] xl:justify-center xl:items-center">
            <div className="w-3/6 max-md:pl-[1.5rem] max-lg:pl-[2rem] text-[2rem] md:text-[3rem] font-bold text-[#F5F5F7] xl:text-center whitespace-nowrap">
              Privacy Policy
            </div>
      ...
      <div className="bg-[#263238] h-screen">
        ...
        <iframe
          ref={iframeRef}
          src="/api/webProxy?url=https://app.websitepolicies.com/policies/view/2albjkzj"
