    ...
    <div className="w-full">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col w-[355px]">
              ...
              <div className="flex justify-end w-full">
                <Button
                  type="submit"
                  className={cn(
                    "w-full md:w-[133px] text-sm p-0 text-white rounded-sm transition-colors duration-200",
      ...
      <div className="mt-8 relative">
        <div className={cn(
          ...
          >
            <span className="text-red-500 hover:text-red-600 text-sm font-normal transition-colors duration-200">
              Delete Your Account
            </span>
            {isDeleteOpen ? (
