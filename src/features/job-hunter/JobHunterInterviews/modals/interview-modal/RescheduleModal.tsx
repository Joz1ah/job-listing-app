...
import { BaseModalProps } from "features/job-hunter/types";
                  ...
                  {isLoading ? (
                    ...
                    <>
                      ...
                      {/* <Button
                        ...
                        className="border-2 text-[13px] font-normal h-[32px] px-6 border-[#168AAD] text-[#168AAD] hover:bg-blue-500 hover:text-white"
                      >
                        View Calendar
                      </Button> */}
                    </>
