        ...
        <DialogContent className="sm:max-w-md">
          ...
          <div className="relative bg-white p-6 rounded-lg text-center">
            ...
            <div className="mb-4">
              ...
              <div className="text-sm text-[#263238] bg-gray-50 p-4 rounded">
      ...
      <Dialog open={isOpen && !showSuccess} onOpenChange={onClose}>
        <DialogContent className="sm:max-w-md">
          ...
          <div className="relative bg-white p-6 rounded-lg">
            ...
            <p className="text-[#263238] text-sm mb-1">
              {interview.position}
            </p>
            ...
            <Button
              ...
              disabled={!rating}
              className="w-full bg-[#F5722E] text-white hover:bg-[#D84315] disabled:bg-gray-300"
              type="button"
            >
              Submit
            </Button>
