  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="w-full max-w-3xl h-[90vh] md:h-[822px] p-0 flex flex-col">
        <div className="flex flex-col h-full">
            ...
            <DialogHeader className="p-4 md:p-6">
              <div className="space-y-3">
                ...
                <div className="flex items-start gap-1">
                  ...
                  <p className="text-base md:text-[17px] break-words">{app.job}</p>
                </div>

                {/* Location */}
                <div className="flex items-start gap-2 text-black">
                  <MapPin className="h-4 w-4 flex-shrink-0 mt-1 text-orange-500" />
                  <span className="text-base md:text-[17px]">Based in {app.location}</span>
                </div>

                {/* Core Skills */}
                <div className="flex flex-col items-start">
                  <h4 className="text-base md:text-[17px] text-black">Core Skills:</h4>
                ...
                <div className="flex flex-wrap items-start gap-2">
                  <h4 className="text-base md:text-[17px] text-black">Experience:</h4>
                ...
                <div className="flex flex-wrap items-start gap-2">
                  <h4 className="text-base md:text-[17px] text-black">Looking For:</h4>
                ...
                {/* Salary Range */}
                <div className="flex flex-wrap items-start gap-2">
                  <h4 className="text-base md:text-[17px] text-black">Salary Expectation:</h4>
                ...
                {/* Languages */}
                <div className="flex flex-wrap items-start gap-2">
                  <h4 className="text-base md:text-[17px] text-black">Languages:</h4>
                  <div className="flex flex-wrap gap-1">
                ...
                {/* Education */}
                <div className="flex flex-wrap items-start gap-2">
                  <h4 className="text-base md:text-[17px] text-black">Education:</h4>
                ...
                <div className="flex flex-col items-start">
                  <h4 className="text-base md:text-[17px] text-black">Interpersonal Skills:</h4>
                  <div className="flex flex-wrap gap-1">
          ...
          <div className="p-4 md:p-6">
            <Button 
                ...
                onClick={() => setIsScheduleModalOpen(true)}  // Add onClick handler
              >
              Schedule Interview
            </Button>
          </div>
        ...
        jobTitle={app.job}
        skills={app.skills}
        certificate="None required"  // You can adjust this as needed
      />
      </DialogContent>
    </Dialog>
